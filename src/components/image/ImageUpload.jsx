...
const ImageUpload = (props) => {
  ...
  return (
    <label
      className={`cursor-pointer flex items-center justify-center border border-dashed border-gray-300 w-full p-5 min-h-[200px] rounded-sm ${className} relative overflow-hidden group`}
    >
      <input
        type="file"
        name={name}
      ...
      {!image && (
        <div
          className="absolute bottom-0 left-0 w-10 h-1 transition-all bg-green-400"
          style={{
